...
const Page = () => {
  ...
  useEffect(() => {
    const savedData = localStorage.getItem('standMeter');
    if (savedData) {
      ...
      setData([
        ...
        },
        {
          ...
          key: false,
          label: false,
          formula: "= DECIMAL(PELANGGAN[STAND LALU])",
          show: true,
          editable: true,
          require: false,
          initialValue: ""
        ...
        },
        {
          ...
          key: false,
          label: false,
          formula: "= [STAND AKHIR] - [STAND LALU]",
          show: true,
          editable: false,
          require: false,
          initialValue: ""
  ...
  useEffect(() => {
    if (data.length > 0) {
      localStorage.setItem('standMeter', JSON.stringify(data));
    }
  }, [data]);
